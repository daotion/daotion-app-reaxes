import type { PopupProps, PopupActions } from './types';

import React, { memo, useState, useRef, useCallback, useEffect, forwardRef, useImperativeHandle } from 'react';
import ReactDOM from 'react-dom';

import { useOnEscape, useRepositionOnResize, useOnClickOutside, useTabbing, useIsomorphicLayoutEffect } from './hooks';
...
export const XPopup = forwardRef<PopupActions, PopupProps>(
  (
    {
      trigger = null,
      onOpen = () => {},
    ...
    const openPopup = useCallback(
      ...
      [isOpen, disabled, onOpen, setIsOpen]
    );
    ...
    const closePopup = useCallback(
      ...
      [isOpen, isModal, disabled, onClose, setIsOpen]
    );
