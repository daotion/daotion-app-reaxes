import { BtnCreateSpaceSvgComponent } from '@@SVGcomponents';
import {
	reaxel_create_space ,
 ...
 */
export const Sider_Space_List = reaxper( class extends Reaxlass<any,{
	...
	memoSetSelectingSpaceIDFromRoute = Reaxes._DEPRECATED_closuredMemo((routeSpaceID:number) => {
		...
		return <>
			...
			<div className={less.joinedSpaceContainer}>
				...
				>
					...
					/>
					<div className={less.joinedSpaceList}
					>
...
export const Homepage_Avatar = reaxper( ( props : { url : string } ) => {
