...
export const DAOAvatar = ComponentWrapper( ( props : { id : number } ) => {
	...
	return <div className = { less.spaceAvatarWrp }>
		<div className = { less.spaceAvatar }>
			<img
			...
			<div className = { less.right }>
				<div className = { less.rightTop }>
					<span className = { less.spaceName }>{ DAOInfo.info.name }</span>
					{
		...
		<div className = { less.spaceInfo }>
			<p className = { less.spaceDec }>
				{ DAOInfo.desc }
			</p>
		...
		<div className = { less.spaceData }>
			<div className = { less.spaceDataItem }>
