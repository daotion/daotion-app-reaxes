export const DetailRevocation = ComponentWrapper(class extends ReactComponentClass {
						...
						<Tabs defaultActiveKey="1" onChange={onChange}>
							<TabPane tab = 'Eligible' key = '1'>
								...
								<div className={less.subContent}>
									...
									<DetailTable columns = {this.columns}></DetailTable>
			...
			render: (text, record, index) => {
				return(
					<div className={less.actionSection}>
						<Button type="link" className={less.editBtn}>Edit</Button>
						{record.editing ? <div><Button type="link">Remove</Button><Button type="link">Reset</Button></div>: ''}
					</div>	
				)	
			}
		},
