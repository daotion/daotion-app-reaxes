		...
		>
			...
			>
				...
				>
					...
					></TitleInput>
					<div className = { less.underline }></div>
			...
			>
				...
				>
					...
					<TitleInput name = "Homepage" placeholder = "Please enter address"></TitleInput>
					<TitleInput name = "Twitter" placeholder = "Please enter address"></TitleInput>
					<TitleInput name = "Discord" placeholder = "Please enter address"></TitleInput>
					<TitleInput name = "GitHub" placeholder = "Please enter address"></TitleInput>
	...
	return <>
		...
		>
			<svg
				...
				xmlns = "http://www.w3.org/2000/svg"
			>
				<g clip-path = "url(#clip0_2540_29067)">
					<path
