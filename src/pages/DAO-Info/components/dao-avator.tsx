    ...
    <div className={less.daoTags}>
      {
        DAOInfo.info.tags.map((item, index) => (
          <div className={less.tag} key={index}>{item}</div>
        ))
      }
    </div>
